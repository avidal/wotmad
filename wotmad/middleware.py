...
class HTTPMethodOverrideMiddleware(object):
    ...
    def __init__(self, app, header_name=None,
        ...
        if allowed_methods:
            ...
            self.allowed_methods = frozenset(['GET', 'HEAD', 'POST', 'DELETE',
                                              'PUT', 'PATCH', 'OPTIONS'])
    ...
    def _get_method_override(self, environ):
        from_env = environ.get(self.header_name, None)
        from_qs = self._get_from_querystring(environ)

        return from_env or from_qs or ''
