...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Script'
        db.create_table('scripts_script', (
            ...
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scripts', to=orm['auth.User'])),
            ('date_submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('scripts', ['Script'])

    def backwards(self, orm):
        # Deleting model 'Script'
        db.delete_table('scripts_script')
