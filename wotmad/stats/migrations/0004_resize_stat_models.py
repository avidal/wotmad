...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('stats_stat', 'sex', CharField(max_length=6))
        db.alter_column('stats_stat', 'faction', CharField(max_length=8))
        db.alter_column('stats_stat', 'klass', CharField(max_length=9))
